...
class ResultScreen extends StatelessWidget {
  ...
  const ResultScreen({super.key, required this.imagePath, required this.documentType});
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              final file = await pdfService.generateEvidencePdf(
                ...
                verdict: 'CHECK_THESE',
                extractedFields: {'product_name': 'Sample', 'mrp': '50'}
              );
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          Text('Check these points', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFFC0392B))),
                          SizedBox(height: 4),
                          Text('Rule P-10: Barcode checksum is invalid.'),
                        ],
                      ),
                    ),
                  ],
